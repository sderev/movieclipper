...
```bash
movieclipper [OPTIONS] [MOVIE_INPUT]
```
...
- **Examples**:
  ...
  movieclipper "Movie" -s 23:45 -d 30
  movieclipper "Movie" -s 1425 -d 30
  ```
...
- **Examples**:
  ```bash
  movieclipper "Movie" -s 1:23:45 -d 0:00:30
  movieclipper "Movie" -s 1:23:45 -d 30
  ```
...
- **Examples**:
  ```bash
  movieclipper "Movie" --stereo -s 1:23:45 -d 30      # Force stereo
  movieclipper "Movie" --no-stereo -s 1:23:45 -d 30   # Keep original channels
  ```
